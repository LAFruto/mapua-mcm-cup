              ...
              ({ url, image, startDate, endDate, isScored }, index) => {
                ...
                return (
                  <Link
                    ...
                    key={index}
                    className={cn(
                      "bg-white  p-4 aspect-square flex items-center justify-between flex-col transition-all duration-300 ease-in-out relative overflow-hidden group wipe-up"
                    )}
                  >
                    <div className="mt-6">
                    ...
                    {eventStatus.type === "countdown" ? (
                      <div className="flex justify-center text-center self-center px-2 lg:px-6 py-1 w-full text-blue-800  uppercase border md:text-lg truncate text-nowrap font-semibold cursor-pointer group">
                      ...
                      <div
                        className={cn(
                          "flex justify-center text-center self-center px-2 lg:px-6 pt-1 pb-1.5 w-full border  md:text-lg truncate text-nowrap font-semibold cursor-pointer group"
                        )}
                      >
                        <div className="h-5 overflow-hidden mr-2">
                          <div className="transform transition-transform duration-300 ease-in-out group-hover:-translate-y-1/2">
                      ...
                      <div className="flex items-center justify-between px-4 lg:px-6 pt-1 pb-1.5 w-full text-white bg-blue-800  md:text-lg truncate text-nowrap font-semibold cursor-pointer group">
                        <div className="h-5  overflow-hidden mr-2">
                          <div className="transform transition-transform duration-300 ease-in-out group-hover:-translate-y-1/2">
